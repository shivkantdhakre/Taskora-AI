...
// Refined editorial palette: champagne primary, warm charcoal, muted slate, terracotta, sage, warm amber.
const COLORS = [
  "#B89B68", // champagne (brand default)
  "#2A2B2F", // midnight ink / graphite
  "#5B8CA8", // muted slate
  "#C4703A", // terracotta
  "#7B9E7B", // muted sage
  "#C49A3C", // warm amber
