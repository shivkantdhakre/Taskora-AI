                ...
                >
                  ...
                  >
                    ...
                    <span
                      ...
                      style={{ background: b.color || "#B89B68" }}
                    />
                    <div className="mb-3.5 flex items-start justify-between">
                      <div
                        className="flex h-11 w-11 items-center justify-center rounded-2xl"
                        style={{
                          backgroundColor: `${b.color || "#B89B68"}1f`,
                          color: b.color || "#B89B68",
                        }}
                      >
...
// champagne shade scaled to a bar's relative height — taller = deeper champagne
const barShade = (pct) =>
  pct >= 0.8
    ? "#8F7954"
    : pct >= 0.5
              ...
              {boards.map((b) => {
                ...
                return (
                  ...
                  >
                    <span
                      className="h-2.5 w-2.5 shrink-0 rounded-full"
                      style={{ backgroundColor: b.color || "#B89B68" }}
                    />
    ...
    >
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="flex flex-1 flex-col gap-3">
          <Legend color="#B89B68" label="Owned" value={owned} />
          <Legend color="#C9C2B5" label="Shared" value={shared} />
        </div>
      </div>
...
const AIPromo = ({ onCreate, className }) => (
  ...
  >
    ...
    <button
      onClick={onCreate}
      className="relative mt-6 inline-flex h-11 items-center justify-center gap-2 rounded-full bg-white px-5 text-sm font-semibold text-neutral-900 shadow-[var(--shadow-card)] transition-transform duration-200 active:scale-[0.97]"
    >
      <Plus className="h-4 w-4" /> New board
    </button>
  </div>
