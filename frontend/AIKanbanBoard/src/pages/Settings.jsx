...
import { LogOut, Command, FolderKanban, CheckSquare, Users } from "lucide-react";
        ...
        <div className="mx-auto max-w-3xl space-y-5 px-6 py-8 md:px-8">
          ...
          <Card title="Workspace" description="Your activity at a glance.">
            <div className="grid grid-cols-3 gap-3">
              <Metric icon={FolderKanban} label="Boards" value={boards.length} tint="#B89B68" />
              <Metric icon={CheckSquare} label="Tasks" value={tasks.length} tint="#5B8CA8" />
              <Metric icon={Users} label="People" value={members.length} tint="#8F7954" />
            </div>
          </Card>
          ...
          <Card title="Preferences" description="Saved to this browser.">
            <div className="flex items-center justify-between gap-4">
              <div>
                ...
                <p className="mt-0.5 text-xs text-muted">Switch between Midnight Ink and Warm Ivory themes.</p>
              </div>
          ...
          <Card title="About">
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <p className="text-sm font-semibold text-ink">Taskora AI</p>
                <p className="text-xs text-muted">
                  AI-native project management · {isDark ? "Midnight Ink" : "Warm Ivory"}
                </p>
              </div>
            </div>
          </Card>
